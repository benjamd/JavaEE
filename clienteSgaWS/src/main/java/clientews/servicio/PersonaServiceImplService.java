 ...
 * 
 */
@WebServiceClient(name = "PersonaServiceImplService", targetNamespace = "http://servicio.benjamd.com.ar/", wsdlLocation = "http://localhost:8080/PersonaServiceImplService/PersonaServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONASERVICEIMPLSERVICE_QNAME = new QName("http://servicio.benjamd.com.ar/", "PersonaServiceImplService");
    ...
    public PersonaServiceWS getPersonaServiceImplPort() {
        return super.getPort(new QName("http://servicio.benjamd.com.ar/", "PersonaServiceImplPort"), PersonaServiceWS.class);
    }
    ...
    public PersonaServiceWS getPersonaServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicio.benjamd.com.ar/", "PersonaServiceImplPort"), PersonaServiceWS.class, features);
    }
